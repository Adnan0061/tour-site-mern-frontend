        ...
        <>
           ...
           <section className='hero-section' style={{height: '75vh'}}>
            ...
            <section className='my-5'>
                <Container>
                <h2 className='my-2' style={{fontSize: '42px'}}>Premium Private and Small Group Tours</h2>
                <h4 className='my-3' style={{fontSize: '28px'}}>Expert Guides Revealing Europe’s Intriguing Histories</h4>
                <p style={{fontSize: '19px'}}>At the crossroads of European history for over 1,000 years, Prague’s soaring churches(opens in a new tab) and ancient synagogues(opens in a new tab) testify to the Czech, German, and Jewish communities that each left their mark on this fabled city, even before it was rebuilt by visionary Emperor Charles IV into the capital of an empire.</p>
                    ...
                    {tours.map((tour) => (
                        ...
                        <Card className='h-100 border-0'>
                            ...
                            <Card.Body>
                                ...
                                <Link to={`/tour/${tour._id}`}  ><Button variant="primary" className='px-5 mx-1' >Book now</Button></Link>
